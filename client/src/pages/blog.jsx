        ...
        <div >
            ...
            <div className=" F-container mt-5">
                        ...
                        <div className="row g-4 pe-5 popular">
                            <a href="/">
                                <div className="col-12 d-flex flex-md-row">
                                    <div className="popular-img me-4"><img src="./test.jpg" alt="" /></div>
                ...
                <div className="classify row g-0 nav nav-tabs" role="tablist" >
                    ...
                    <div className="classify-img col-md-4 col-12">
                        <a className="" data-bs-toggle="tab" role="tab" href='#FITNESS' aria-controls="FITNESS" aria-selected="true" tabIndex="0">
                            <img src="/image/blog/fitness.jpg" className="img-fluid " alt="" />
                            <div >FITNESS</div>
                        </a>
                    </div>
                    <div className="classify-img col-md-4 col-12">
                        <a className="" data-bs-toggle="tab" href="#NUTRITION" role="tab" aria-controls="NUTRITION" aria-selected="true" tabIndex="0">
                            <img src="/image/blog/nutrition.jpg" className="img-fluid" alt="" />
                            <div >NUTRITION</div>
                        </a>
                    </div>
                </div>
                <div className='articlelist'>
                    <div className="row g-0  tab-content">
                        <div className="col-lg-8 col-md-12 flex-column fade tab-pane show active" id='HEALTHY'>
                            <div className="article  d-flex align-items-center row" >
                                <a href="/">
                                    <div className=" col-md-6 col-12 article-img">
                                        <div>
                                            <img src="./1c4e27dcfbe370a7f4cd4b5243d88bc2.jpg" alt="" className="img-fluid" />
                                        </div>
                                    </div>
                                    <div className="article-text col-6 ms-5">
                                        ...
                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                                            ...
                                            has been the industry's standard dummy text ever since the 1500s, when an u</p>
                                        <div className="Userfeedback d-flex flex-row"><span><img src="./images/conversation.png"
                                            alt="" />100</span><span className="ms-auto"><img src="./images/send.png"
                                                alt="" /></span>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div className="col-lg-8 col-md-12 flex-column fade tab-pane show " id='NUTRITION'>
                            <div className="article  d-flex align-items-center row" >
                                <a href="/">
                                    <div className=" col-md-6 col-12 article-img">
                                        <div>
