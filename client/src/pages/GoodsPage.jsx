    ...
    return (
        <div>
            <div className="goodstype">
                <div className="diet">
                    <a href="http://localhost:3000/goods" className="myDiet">增肌減脂餐盒</a>
                </div>
                <div className="drink">
                    <a href="http://localhost:3000/goods" className="myDrink">乳清蛋白</a>
                </div>
            </div>
            ...
            <div className="goodsCard myGoodscontain">
                <div className="goodsImage">
                    <div className="bigGroup">
                        ...
                        <img src="./image/store/good1.png" className="bigImage" alt="大圖" />
                        <button className="nextBtn">＞</button>
                    </div>
                    <div className="smallGroup">
                        <img src="./image/store/good1.png" className="smallImage active" data-target="./image/store/good1.png" alt="小圖" />
                        <img src="./image/store/good2.png" className="smallImage" data-target="./image/store/good2.png" alt="小圖" />
                        <img src="./image/goods/chicken.png" className="smallImage" data-target="./image/goods/chicken.png" alt="小圖" />
                    </div>
                </div>
                <div className="goodsText">
                    ...
                    <button id="deBtn" className="increaseBtn">一</button>
                    <div className="addingQty">
                        <input type="text" id="addGoods" value="1" />
                    </div>
                    <button id="inBtn" className="increaseBtn">十</button>
                    <br />
                    <br />
                    ...
                    <br /><br />
                    <button className="joinFollow"><img src="./image/goods/heart.png" alt="最愛" /> 加入最愛</button>
                </div>
            </div>

            <br /><br /><br />
            <div className="myGoodscontain mygoodsExplain">
                <div className="mygoodsIntro">
                    商品介紹
                </div>
                <div className="mygoodsSave">
                    保存方式
                </div>
            </div>
            <br /><br /><br />
            <div className="myGoodscontain">
                ...
                <div>
                    <p className="sParagraph">內容物：
                        白酒菲力鬼頭刀：鬼頭刀,白酒,柳丁,鹽,黑胡椒粉
            ...
            <div className="myGoodscontain">
                ...
                <div>
                    <p className="sParagraph">
                        ...
                        平底鍋：將包裝拆除放到鍋中，加熱至所需溫度。</p>
                </div>
            </div>
            <br /><br /><br /><br /><br /><br />
            <div className="recommendBar">
                <div className="myGoodscontain recomGoods">
                    <a href="http://localhost:3000/goods" className="jumpPage" target="_blank"  rel="noreferrer">
