        ...
        <div className="mybody">
            ...
            <div className="goods">
                ...
                <div className="goodGroup">
                    <div>
                        <img className="goodPic" src="./image/store/good1.png" alt="第一個商品圖" />
                    </div>
                    ...
                    <div className="buttonGroup">
                        ...
                        <p className="bigPrice">NT$<span id="addingGoodsPrice">160</span></p>
                    </div>
                    <div>
                ...
                <div className="goodGroup">
                    <div>
                        <img className="goodPic" src="./image/store/good1.png" alt="第二個商品圖" />
                    </div>
                    <div className="goodText">
                        <p className="goodName">波波明太子舒肥雞腿餐盒</p>
                        <p className="goodPrice">NT$ 160</p>
                    ...
                    <div className="buttonGroup">
                        ...
                        <p className="bigPrice">NT$<span id="addingGoodsPriceOne">160</span></p>
                    </div>
                    <div>
                        <button className="deBtn">X</button>
                    </div>
                ...
                <hr className="myhr" />
                <p className="smallTopic goodQtys">購物車合計有<span id="addingTotalQty">2</span>項商品</p>
            </div>
            ...
            <div className="goods">
                <div className="memberBox">
                    ...
                    <span className="remindText">訂單通知會寄到此信箱, 請您務必填入正確的E-MAIL</span>
                </div>
                <hr className="myhr" />
                ...
                <div className="memberBox">
                    <div>
                        ...
                        <button type="button" className="specOff">選擇優惠券或輸入優惠碼</button>
                    </div>
                </div>
                ...
                <div className="memberBox">
                    ...
                    <span className="remindText">*超商取貨時請使用本名, 並記得攜帶身分證前往取貨</span>
                    <br />
                    <div>
                        <span className="takingName"> 聯絡電話</span>
                        <input type="text" className="fillFrame" placeholder="購買人聯絡電話,例: 0911222333" />
                    </div>
                    <span className="remindText">*取貨通知將以此電話聯繫, 請勿加入任何空格或符號, 使用超商取貨誤請務必填寫10碼手機, 如: 0911222333</span>
                    <div>
                        <br />
                        <input type="checkbox" id="sameAsBuyer" className="radioFrame" />&nbsp;&nbsp;&nbsp;&nbsp;<label
                            htmlFor="sameAsBuyer"><span className="takingName sameBuyer">與購買者相同</span></label>
                    </div>
                </div>
            </div>
            ...
            <div className="goods">
                <div className="memberBox">
                    <div>
                        ...
                        <div className="deliveryWay">
                            <button name="dChoose" type="button" className="specialOff defaultCon"
                                onclick="showConvenient()">超商</button>
                            <button name="dChoose" type="button" className="specialOff" onclick="showHomedelivery()">宅配</button>
                        </div>
                    </div>
                </div>
                <hr className="myhr" />
                ...
                <div className="memberBox convenientBox">
                    <div>
                        ...
                        <button name="cChoose" type="button" className="cWhich defaultSelect">
                        ...
                        <button type="button" className="selectSeven">請選擇取貨門市</button>
                    </div>
                </div>
                    ...
                    <div>
                        <div className="addGroup">
                            <select className="citySel">
                                <option  defaultValue="" selected>請選擇縣市</option>

                            </select>
                            <select className="sectionSel">
                                <option  defaultValue="" selected>請選擇鄉鎮市區</option>
            ...
            <div className="goods">
                <div className="memberBox">
                    ...
                    <span className="countReminder">請注意,訂單為您對於本公司所發出的採購邀約,本公司於未發出出貨通知以前,仍保有同意買賣契約成立與否的權利。</span>
                    ...
                    <div className="invoiceGroup invoiceTypeOne">
                        <input name="invoice1" type="radio" id="phone" onclick="showDeliveryBox()" checked />
                        <label htmlFor="phone"><span className="invoiceText">手機條碼載句</span></label>

                        <input name="invoice1" type="radio" id="letter" onclick="showLetterBox()" />
                        <label htmlFor="letter"><span className="invoiceText">紙本發票</span></label>

                        <input name="invoice1" type="radio" id="future" onclick="showcloudBox()" />
                        <label htmlFor="future"><span className="invoiceText">自然人憑證條碼載具</span></label>
                    </div>
                    ...
                    <div className="deliveryBox ">
                        <input type="text" className="cloudIv" placeholder="請輸入手機條碼載具" />
                    </div>

                    <div className="cloudBox hiddenIv">
                        <input type="text" className="cloudIv" placeholder="共16碼大寫英數字" />
                    </div>

                    <div className="invoiceGroup hiddenIvGroup invoiceTypeTwo">
                        <input name="invoice2" type="radio" id="phone" />
                        <label htmlFor="phone"><span className="invoiceText">基金會</span></label>

                        <input name="invoice2" type="radio" id="letter" checked />
                        <label htmlFor="letter"><span className="invoiceText">基金會</span></label>

                        <input name="invoice2" type="radio" id="future" />
                        <label htmlFor="future"><span className="invoiceText">基金會</span></label>
                    </div>

                    <div className="cloudBox hiddenIvGroup invoiceTypeThree">
                        <input type="text" className="cloudIv" placeholder="請輸入統一編號" />
                        <input type="text" className="cloudIv" placeholder="請輸入公司名稱" />
                    </div>
            ...
            <div className="counter">
                ...
                <div className="typingIv">
                    <p>折扣</p>
                    <button className="vIcon" onclick="showDiscount()"><img src="./image/shoppingcart/letter-v.png" alt="V" /></button>
                    <p>-NT$0</p>
                </div>
            ...
            <div className="finalCounter">
                ...
                <div className="typingIv">
                    <p>購物車內容</p>
                    <button className="bigvIcon" onclick="showmyShopping()"><img className="vImage"
                        src="./image/shoppingcart/letter-v.png" alt="V" /></button>
                </div>
                <div id="myShoppingList" className="myShoppingFamily">
                    <div className="myShoppingGroup">
                        <div className="myShopping">波波明太子舒肥雞腿餐盒&nbsp;&nbsp;X&nbsp;&nbsp;1</div>
            ...
            <div className="cupponHidden hinds">
                <div className="hiddenBox">
                    ...
                    <div className="cupponGroup">
                        <div className="borderLine"><img className="myLogo" src="./image/store/good1.png" alt="優惠券" /></div>
